...
namespace Bai_3._2_XuLyChuoi
{
    class Program
    {
        ...
        public static void checkSo()
        {
            ...
            Console.WriteLine("Chúc mừng bạn đã nhập đúng kiểu dữ liệu");
        }

        public static bool checkSo(string text)
        {
            return Regex.IsMatch(text, @"^\d+$");
            // Console.WriteLine(int.TryParse(input, out _));
        }
